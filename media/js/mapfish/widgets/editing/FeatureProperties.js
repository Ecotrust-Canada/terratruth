...
/**
 * Class: mapfish.widgets.editing.TextProperty
 * Extends <mapfish.widgets.editing.BaseProperty> to show multiline text
 * properties with an <Ext.form.TextArea>.
 */
mapfish.widgets.editing.TextProperty = function(config) {
    mapfish.widgets.editing.TextProperty.superclass.constructor.call(this, config);
};
Ext.extend(mapfish.widgets.editing.TextProperty, mapfish.widgets.editing.BaseProperty, {
    /**
     * Method: getExtField
     * Returns an Ext textarea.
     *
     * Returns:
     * {Ext.form.TextArea} The Ext textarea.
     */
    getExtField: function() {
        return new Ext.form.TextArea(OpenLayers.Util.applyDefaults({
            name: this.name,
            fieldLabel: this.label || this.name
        }, this.extFieldCfg));
    }
