...
Ext.extend(mapfish.widgets.recenter.DataField, mapfish.widgets.recenter.Base, { 
    ...
    /**
     * APIProperty: comboOptions
     * {Object} Options to be passed to the ComboBox constructor.
     */
    comboOptions: null,

    /**
     * APIProperty: storeFields
     * {Array} Options to be passed to the GeoExt.data.FeatureReader
     *     If none is provided, only passed displayField will be
     *     loaded in store
     */
    storeFields: null,
    ...
    addItems: function() {
        ...
        var store = new Ext.data.Store({
            reader: new GeoExt.data.FeatureReader({}, this.storeFields || [
