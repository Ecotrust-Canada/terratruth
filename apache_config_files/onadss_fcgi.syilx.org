...
<VirtualHost *:443>
  ...
  Alias /media-admin /usr/local/apps/terratruth/ENV/django/contrib/admin/media
...
<VirtualHost *:80>
  ServerName terratruth.example.com
  DocumentRoot /var/www/terratruth.example.com
